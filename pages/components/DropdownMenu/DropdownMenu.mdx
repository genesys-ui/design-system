...
Preview the DropdownMenu component with the React live demo. For detailed code usage
...
<DesignTokensList
  tokens={getCmpTokensJson('dropdownMenu')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('dropdownMenu').length} DropdownMenu design
