...
Preview the ButtonGroup component with the React live demo. For detailed code usage
...
<DesignTokensList
  tokens={getCmpTokensJson('buttonGroup')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('buttonGroup').length} ButtonGroup design
