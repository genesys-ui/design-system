...
<section className="mrow">
  <div className="mcol-12 mcol-sm-6">
    <CardReact url="https://devoinc.github.io/genesys-ui/?path=/docs/components-button-button--docs" />
  </div>
  <div className="mcol-12 mcol-sm-6">
    <CardHtml url="https://devoinc.github.io/genesys-styles/?path=/docs/components-button--docs" />
  </div>
</section>
