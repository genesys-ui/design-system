...
Preview the Divider component with the React live demo. For detailed code usage
...
<DesignTokensList
  tokens={getCmpTokensJson('divider')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('divider').length} Divider design tokens. The
