...
Preview the Thumbnail component with the React live demo. For detailed code usage
...
<section className="mrow">
  <div className="mcol-12 mcol-sm-6">
    <CardReact url="https://devoinc.github.io/genesys-ui/?path=/docs/components-core-media-thumbnail--docs" />
  </div>
  <div className="mcol-12 mcol-sm-6">
...
<DesignTokensList
  tokens={getCmpTokensJson('thumbnail')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('thumbnail').length} Thumbnail design tokens.
