...
<LiveDemo
  ...
  urlHtml="https://devoinc.github.io/genesys-styles/?path=/docs/components-input--docs"
  urlReact="https://devoinc.github.io/genesys-ui/?path=/docs/components-form-input--docs"
/>
...
<DesignTokensList
  tokens={[
    // TODO: problem with styled components when it's used this (maybe because of background-image)
    //...getCmpTokensJson('inputControl'),
