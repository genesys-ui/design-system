...
Preview the FloatPanel component with the React live demo. For detailed code usage
...
<section className="mrow">
  <div className="mcol-12 mcol-sm-6">
    <CardReact url="https://devoinc.github.io/genesys-ui/?path=/docs/components-core-layout-divider--docs" />
  </div>
  <div className="mcol-12 mcol-sm-6">
