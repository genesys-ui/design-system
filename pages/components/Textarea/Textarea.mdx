...
Preview the Textarea component with the React live demo. For detailed code usage
...
<DesignTokensList
  tokens={getCmpTokensJson('textarea')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('textarea').length} Textarea design tokens.
