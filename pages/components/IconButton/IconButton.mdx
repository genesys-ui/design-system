...
<section className="mrow">
  <div className="mcol-12 mcol-sm-6">
    <CardReact url="https://devoinc.github.io/genesys-ui/?path=/docs/components-core-button-iconbutton--docs" />
  </div>
  <div className="mcol-12 mcol-sm-6">
...
<Figure caption="The internal structure and specs of the IconButton component.">
  <Figma url="https://www.figma.com/file/4f9wa0fKYIwMue6yo6nrJL/Genesys---Doc---assets?type=design&node-id=6813%3A15896&mode=design&t=b2udXn5P7nBGEN0k-1" />
</Figure>
...
<DesignTokensList
  tokens={getCmpTokensJson('button')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('button').length} Button design tokens. The
