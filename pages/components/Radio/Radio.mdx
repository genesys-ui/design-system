...
Preview the Radio component with the React live demo. For detailed code usage
...
<DesignTokensList
  tokens={getCmpTokensJson('radio')}
  intro={
    <p style={{ margin: '1.6rem 0' }}>
      There are {getCmpTokensJson('radio').length} Radio design tokens. The
