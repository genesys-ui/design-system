...
import { Figma, Figure, Col, Row } from '../../blocks';
...
<Figure noBorder>
  <img
    alt="Symbol of form layout pattern"
    src="img/patterns-form-layout.png"
  />
</Figure>
...
The way the form fields will be distributed will be by default in one column, placing the fields one below the other.
This facilitates the reading order and avoids the user having to follow the 'Z pattern' (zig-zag reading).
In this way, it is easier to complete each of the fields.
...
<Figure caption="Predefined widths for field controls to use when we know the expected data.">
  <Figma aspectRatio="3x4" url="https://www.figma.com/file/jnaeLlECvyRS5DCwH99Tie/GDS---Web-Previews?node-id=15-6226&t=Rfn4QWfxovBW8dEZ-1" />
</Figure>
