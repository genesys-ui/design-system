...
Elevation hierarchy defines how depth and shadows are used to show the relative importance of elements
 in a design system, so it creates clear visual layers that guide the user.
