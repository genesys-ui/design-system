...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  ...
  <div className="col">
    <Figure
      ...
      caption=""
    >
     **<em>Select a new password.</em>**<br/>
     <br/>
    </Figure>
  </div>
</section>
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>An error has occurred during the login process and you cannot log in to your account, please try again.</em>**
    </Figure>
  </div>
  <div className="col">
    <Figure
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  ...
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>A domain with this name already exists. Please enter a new name.</em>**
    </Figure>
  </div>
</section>
...
Use modal verbs to express ideas such as ability, uncertainty, necessity and permission. Use modal verbs sparingly and at your discretion, and always use the correct verb for the instruction.
  <Figure
      ...
      caption=""
    >
    **<em>Avoid the modal verbs shall, might, would, and ought to in your writing.</em>**
    </Figure>
    ...
    <Figure
      ...
      caption=""
    >
    **<em>Can:</em>** Relates to present ability and general possibility.<br/>
**<em>Could:</em>** Relates to possibility and suggestion.<br/>
**<em>May:</em>** Relates to probability and permission. It also means that an item      
is optional.<br/>
**<em>Need:</em>** Relates to the absence of obligation. In technical documentation, 
this verb is used only as a synonym for the verb want.<br/>
**<em>Must:</em>** Relates to personal obligation. It means that the definition is an 
absolute requirement of the specification.<br/>
**<em>Have to:</em>** Relates to impersonal obligation. Don't use it as a synonym for 
the verb must.<br/>
**<em>Should:</em>** Relates to expectation and recommendation. Don't use it as a 
synonym for the verb must.<br/>
    </Figure>
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>In Data Search, The Tabs Would Be Explore Your Data, Search History,   
Query Management, And Lookup Management.</em>**<br/>
    </Figure>
  </div>
  <div className="col">
    <Figure
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>USE THE CREDENTIALS CREATED HERE TO AUTHENTICATE REST API REQUESTS AND DEVO RELAY CONNECTIONS TO THE DEVO PLATFORM.</em>**<br/>
    </Figure>
  </div>
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>Use the credentials created here to authenticate REST API requests and Devo Relay connections to the Devo Platform.</em>**
    </Figure>
  </div>
</section>
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    ...
    >
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>US dollar</em>**<br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>Canadian dollar</em>**<br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>British pound</em>**<br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>Japanese yen</em>**<br/>
    </Figure>
  </div>
  <div className="col">
  </div>
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      ...
      caption=""
    >
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>USD450, then $450</em>**<br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>EUR100, then €100</em>**<br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**<em>JPY250, then ¥250</em>**<br/>
    </Figure>
  </div>
  <div className="col">
  </div>
...
Drop the pronoun whenever you can: 
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>"The category length cant be more than six characters." </em>**<br/>
    </Figure>
  </div>
  <div className="col">
    <Figure
...
<Figure
      ...
      caption=""
    >
   **<em>CPUs, APIs, IDs, OSs, the 1990s, 0s, and 1s</em>**<br/>**<em>FAQ: frequently asked questions</em>**
    </Figure>
...
Do not use (s), /s, (es), or /es at the end of a word to indicate the possibility of more than one item, and do not combine the singular and plural forms of a verb, such as is/are.
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      type="dont"
      caption=""
    >
    **<em>Close any application(s) that is/are open. </em>**<br/>
    </Figure>
  </div>
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>Close any application that is open.</em>**<br/>
...
<section className="row gy-4 row-cols-1 row-cols-sm-2 margin-top--lg">
  <div className="col">
    <Figure
      ...
      caption=""
    >
    **<em>Android, iOS and Windows</em>**<br/>
    </Figure>
  </div>
  <div className="col">
    <Figure
...
### 13. Possessives	
   To form the possessive case of nouns, add an apostrophe and an s, even if the noun ends in s, x, or z. To form the possessive of plural nouns that end in s, add only an apostrophe.
<Figure
      type="do"
      caption=""
    >
   **<em>the table's contents</em>**<br/>
   **<em>the box's contents</em>**<br/>
   **<em>users' accounts</em>**<br/>
   **<em>the Joneses' computer</em>**
    </Figure>

### 14. Pronouns
 Use the second person singular (you, your) whenever possible. This is a friendly and direct way to communicate with the user. 
<Figure
      type="do"
      caption=""
    >
  ...
  Use the first person for tabs and sections that are specific to the user, such as **My account**, **My domains**, or **My data**.
<Figure
      type="do"
      caption=""
    >
   **“My favorite searches”** in the Data Search.<br/>
...
<Figure
      ...
      caption=""
    >
   **<em>For the possessive form of it.</em>**<br/>
   **<em>With a possessive pronoun.</em>**<br/>
...
<ins>Use semicolons:</ins>
- Between two independent clauses that are not joined by a conjunction.
- Between contrasting statements that are not joined by a conjunction.
...
#### Exclamation points/marks
  Exclamation points should not be used. In the unusual case of it being appropriate to use one, never end a sentence with more than one exclamation point.
<Figure
      type="dont"
      caption=""
    >
   **<em>Never end a sentence with more than one exclamation point!!!!!!</em>**<br/>
   **<em>Does that apply to question marks, too?????</em>**<br/>
   **<em>Yes!!!!!!!</em>**
</Figure>
#### Periods (full stops)
...
- Use noun phrases for first-level headings, verb phrases for second-level headings, and infinitive phrases for headings in instructions.

<Figure
      type="do"
      caption=""
    >
   **<em>Activeboards / Working with Activeboards / To share an Activeboard</em>**
</Figure>
...
- Don't end headings with a period. Use your own judgement if a question mark is needed in certain cases:

<Figure
      type="do"
      caption=""
    >
**1. What can we help you find?**<br/>
...
### 17. US English (Spelling)	
 ...
 <Figure
      ...
      caption=""
    >
**<em>canceled not cancelled</em>**<br/>
**<em>emphasize not emphasise</em>**<br/>
**<em>focused not focussed</em>**<br/>
**<em>program not programme</em>**<br/>
**<em>disk not disc</em>**
</Figure>
...
<section className="mrow">
  <div className="mcol-12 mcol-sm-6">
Action labels are the middlemen between your product and its users, any confusion or hesitation could lead to dissatisfaction on the users’ behalf, which in turn could lead to frustration and poor user experience. 
</div>
  <div className="mcol-12 mcol-sm-6 mt-4">
   <Figure>
  <img
