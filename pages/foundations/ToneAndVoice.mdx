...
Use the first person for tabs and sections that are specific to the user, such as
**My account**, **My domains**, or **My data**.
<Figure type="do" caption="">
...
#### Periods (full stops) Do not use periods in headings, subheadings, UI titles,
...
<Figure type="do" caption="">
  **<em>Do you want to save your changes?</em>**
  <br />
